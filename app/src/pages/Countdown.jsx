...
export default function Countdown() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg,#14141F,#1E1E2E)', color: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: 'clamp(16px, 5vw, 40px)' }}>
      ...
      <div className="mont" style={{ fontSize: 'clamp(56px, 18vw, 110px)', fontWeight: 800, letterSpacing: '.02em', margin: '12px 0 8px', lineHeight: 1.05 }}>{fmtTime(left)}</div>
      ...
      <div className="xs" style={{ color: '#8A8B9A', marginTop: 'clamp(24px, 7vw, 56px)' }}>O início é automático. Boa sorte! 🍀</div>
    </div>
  );
}
